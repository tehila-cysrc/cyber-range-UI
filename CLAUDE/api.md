...
| GET | `/documentation-categories` | Active categories, any authenticated user. Seeded set now includes `ioc` ("Indicator of Compromise (IOC)"); more can be added on the fly (see below) — this is CONFIG data, survives an event reset. |
